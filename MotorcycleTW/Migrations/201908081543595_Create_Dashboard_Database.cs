namespace MotorcycleTW.Migrations
{
    ...
    public partial class Create_Dashboard_Database : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        p_id = c.Int(nullable: false),
                        Order_Detail2_od_id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.od_id)
                .ForeignKey("dbo.Order_Detail", t => t.Order_Detail2_od_id)
                .ForeignKey("dbo.Orders", t => t.o_id, cascadeDelete: true)
                .ForeignKey("dbo.Products", t => t.p_id)
                .Index(t => t.o_id)
                .Index(t => t.p_id)
                .Index(t => t.Order_Detail2_od_id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Order_Detail", "Order_Detail2_od_id", "dbo.Order_Detail");
            ...
            DropIndex("dbo.Order_Detail", new[] { "Order_Detail2_od_id" });
